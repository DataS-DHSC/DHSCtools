...
This code has been developed in-house and not extensively tested, if you find
any bugs or have suggestions of other functions to add please raise an issue
in this repository.
...
git on the DHSC estate through a wired connection (only works if repo was
cloned via https rather than ssh):
